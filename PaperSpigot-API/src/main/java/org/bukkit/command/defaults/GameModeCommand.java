...
public class GameModeCommand extends VanillaCommand {
    ...
    public GameModeCommand() {
        ...
        this.setPermission("cmd.gamemode");
    ...
    public boolean execute(CommandSender sender, String currentAlias, String[] args) {
        ...
        if (player != null) {
            ...
            if (mode == null) {
                if (modeArg.equalsIgnoreCase("creative") || modeArg.equalsIgnoreCase("c")|| modeArg.equalsIgnoreCase("c")) {
                    mode = GameMode.CREATIVE;
                } else if (modeArg.equalsIgnoreCase("adventure") || modeArg.equalsIgnoreCase("a")|| modeArg.equalsIgnoreCase("a")) {
                    mode = GameMode.ADVENTURE;
                } else if (modeArg.equalsIgnoreCase("spectator") || modeArg.equalsIgnoreCase("sp")| modeArg.equalsIgnoreCase("sp")) {
            ...
            if (mode != player.getGameMode()) {
                ...
                sender.sendMessage(player.getName() + " já está no gamemode " + mode.getValue());
            }
        } else {
