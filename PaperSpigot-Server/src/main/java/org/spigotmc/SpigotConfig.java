...
public class SpigotConfig
{
    ...
    private static void messages()
    {
        ...
        unknownCommandMessage = transform( getString( "messages.unknown-command", "§cComando não encontrado" ) );
        serverFullMessage = transform( getString( "messages.server-full", "Servidor lotado!" ) );
